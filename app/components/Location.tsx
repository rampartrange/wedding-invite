  ...
  return (
    <section id="location" style={{ background: 'rgba(158,168,75,0.8)', padding: 'clamp(60px,8vw,100px) clamp(20px,5vw,60px)' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        <h2 style={{ fontSize: 'clamp(2.2rem,6vw,3.5rem)', color: '#ffffff', marginBottom: '15px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400, animation: 'fadeInUp 0.8s ease-out forwards', textAlign: 'center' }}>
          Как добраться
        </h2>
        ...
        <div style={{ backgroundColor: '#f5f0e8', borderRadius: '24px', boxShadow: '0 8px 30px rgba(0,0,0,0.15)', padding: '40px' }}>
          ...
          <div style={{ background: '#b8505f', color: 'white', padding: '32px 36px', borderRadius: '16px', marginBottom: '28px', position: 'relative', overflow: 'hidden' }}>
            ...
            <p style={{ fontSize: 'clamp(1rem,2vw,1.15rem)', lineHeight: 1.75, fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>
          ...
          <div style={{ background: '#fffbea', borderLeft: '5px solid #e8b860', padding: '20px 24px', borderRadius: '0 12px 12px 0', marginBottom: '28px' }}>
            <div style={{ fontFamily: "'Zhizn', sans-serif", fontSize: '1rem', color: '#b8505f', marginBottom: '8px', fontWeight: 400 }}>⚠️ Важно знать</div>
            <p style={{ fontFamily: "'Zhizn', sans-serif", fontSize: '0.95rem', lineHeight: 1.7, color: '#2c2c2c' }}>
          ...
          <div style={{ backgroundColor: 'rgba(255,255,255,0.6)', padding: '20px', borderRadius: '16px', marginBottom: '28px' }}>
            <h3 style={{ fontSize: '1.3rem', color: '#b8505f', marginBottom: '18px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>✈️ Аэропорты поблизости</h3>
            <div className="airports-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '12px' }}>
              {airports.map(a => (
                ...
                >
                  ...
                  <div style={{ fontFamily: "'Zhizn', sans-serif", fontSize: '1.1rem', color: 'white', fontWeight: 400 }}>{a.name}</div>
                  <div style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.8)', marginTop: '4px', fontFamily: "'Zhizn', sans-serif" }}>{a.note}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ borderLeft: '4px solid #e8b860', paddingLeft: '20px', marginBottom: '28px' }}>
            <h3 style={{ fontSize: '1.2rem', color: '#2c2c2c', marginBottom: '14px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>Варианты транспорта</h3>
              ...
              {transport.map(t => (
                <div
                  ...
                  style={{
                    ...
                    fontFamily: "'Zhizn', sans-serif", fontSize: '0.95rem',
            ...
            <div style={{ marginTop: '18px', background: 'rgba(158,168,75,0.12)', border: '1px solid rgba(158,168,75,0.4)', borderRadius: '12px', padding: '14px 18px', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <p style={{ fontFamily: "'Zhizn', sans-serif", fontSize: '0.9rem', lineHeight: 1.65, color: '#2c2c2c' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '15px', background: '#ffffff', borderRadius: '12px' }}>
            ...
            <a href={MAPS_WEB_URL} onClick={openMaps} rel="noopener noreferrer" style={{ fontSize: '0.95rem', color: '#2c2c2c', textDecoration: 'none', borderBottom: '1px dashed #9ea84b', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>
