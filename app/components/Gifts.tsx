  ...
  return (
    <section id="gifts" style={{ padding: 'clamp(60px,8vw,100px) clamp(20px,5vw,60px)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <h2 style={{ fontSize: 'clamp(2.2rem,6vw,3.5rem)', color: '#f5f0e8', marginBottom: '15px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400, animation: 'fadeInUp 0.8s ease-out forwards', textAlign: 'center' }}>
          Подарки
        </h2>
        ...
        <div className="two-col-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', alignItems: 'center' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.15)', borderRadius: '24px', padding: '48px 32px', textAlign: 'center', backdropFilter: 'blur(4px)', boxShadow: '0 8px 30px rgba(0,0,0,0.2)' }}>
            ...
            <p style={{ fontFamily: "'Zhizn', sans-serif", fontWeight: 400, fontSize: '1.15rem', color: '#f5f0e8', lineHeight: 1.6 }}>
          ...
          <div style={{ backgroundColor: 'rgba(255,255,255,0.93)', borderRadius: '24px', boxShadow: '0 8px 30px rgba(0,0,0,0.15)', padding: '36px' }}>
            <p style={{ fontSize: '1.05rem', color: '#2c2c2c', lineHeight: 1.8, marginBottom: '20px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>
            ...
            <div style={{ backgroundColor: 'rgba(184,80,95,0.08)', padding: '18px', borderRadius: '14px', marginBottom: '18px' }}>
              <h3 style={{ fontSize: '1.15rem', color: '#b8505f', marginBottom: '8px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>Если хотите что-то подарить</h3>
              <p style={{ fontSize: '0.95rem', color: '#2c2c2c', lineHeight: 1.7, fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>
            ...
            <div style={{ borderLeft: '4px solid #e8b860', paddingLeft: '16px' }}>
              <h3 style={{ fontSize: '1.15rem', color: '#b8505f', marginBottom: '8px', fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>🌸 Просьба без цветов</h3>
              <p style={{ fontSize: '0.95rem', color: '#2c2c2c', lineHeight: 1.7, fontFamily: "'Zhizn', sans-serif", fontWeight: 400 }}>
